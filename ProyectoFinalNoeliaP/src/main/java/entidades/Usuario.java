...
public class Usuario implements Serializable {
    ...
    public Usuario(Integer idusu, String nombre, String email, Date fechaRegistro, List<Obra> obraList) {
        this.idusu = idusu;
        this.nombre = nombre;
        this.email = email;
    ...
    public Usuario(Integer idusu, String nombre, String email) {
        this.idusu = idusu;
        this.nombre = nombre;
        this.email = email;
    }
    ...
    public String toString() {
        ...
        return idusu + "\t" + nombre + "\t" + email + "\t" + df.format(fechaRegistro)+"\n";
    }
